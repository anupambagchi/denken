...
def CrossDown = WilliamsPercentSmoothed < -50 && WilliamsPercentSmoothed[1] >= -50;

SetColor(GetColor(1));

addOrder(CrossDown and safetime, open[-1], tradeSize);
alert(CrossDown and safetime, "WPR Short Entry.", Alert.BAR, Sound.NoSound);
