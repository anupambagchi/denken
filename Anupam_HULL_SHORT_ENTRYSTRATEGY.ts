...
def isDOWN = condition1 and condition2 and condition3;
def isDOWNprevious = condition1p and condition2p and condition3p;

SetColor(GetColor(1));

addOrder(isDOWN and !isDOWNPrevious and safetime, open[-1], tradeSize);
alert(isDOWN and !isDOWNPrevious and safetime, "HULL Short Entry.", Alert.BAR, Sound.NoSound);
