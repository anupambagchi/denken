...
def atrbuy = ATRTrailingStop(trailType, ATRPeriod, ATRFactor, firstTrade).buySignal and WilliamsPercentSmoothed > -50;

SetColor(GetColor(0));

addOrder(atrbuy and safetime and trendqualitygood, open[-1], tradeSize);
alert(atrbuy and safetime and trendqualitygood, "ATR Long Entry.", Alert.BAR, Sound.NoSound);
